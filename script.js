...
async function fetchReviews() {
    ...
    // You can replace this with the real API later
    const data = [
      {
        ...
        "rating": 5,
        "reviewer": "Sarah Ali",
        "shortReview": "Excellent course, learned a lot.",
        "fullReview": "The course was detailed and challenging. Highly recommend!",
